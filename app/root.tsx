...
export function ErrorBoundary({ error }: Route.ErrorBoundaryProps) {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#030712] text-gray-100">
      <div className="text-center">
        ...
        {stack && (
          <pre className="mt-8 w-full max-w-2xl p-4 overflow-x-auto bg-surface-800 rounded-xl text-left text-xs text-gray-400">
            <code>{stack}</code>
          </pre>
        )}
      </div>
